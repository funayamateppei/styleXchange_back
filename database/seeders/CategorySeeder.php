...
class CategorySeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('categories')->insert([
            ...
            ['name' => 'スカート', 'parent' => '4', 'gender' => '1', 'big_category' => true],
            ['name' => 'ワンピース', 'parent' => '5', 'gender' => '1', 'big_category' => true],
            ...
            ['name' => 'スーツ', 'parent' => '11', 'gender' => '0', 'big_category' => true],
            ['name' => 'スーツ/フォーマル/ドレス', 'parent' => '12', 'gender' => '1', 'big_category' => true],
            ['name' => 'その他', 'parent' => '0', 'gender' => '2', 'big_category' => true],

            // トップス
            ['name' => 'Tシャツ(半袖/袖なし)', 'parent' => '1', 'gender' => '2', 'big_category' => false],
            ['name' => 'ロンT(七分/長袖)', 'parent' => '1', 'gender' => '2', 'big_category' => false],
            ['name' => 'シャツ', 'parent' => '1', 'gender' => '0', 'big_category' => false],
            ['name' => 'シャツ/ブラウス(半袖/袖なし)', 'parent' => '1', 'gender' => '1', 'big_category' => false],
            ['name' => 'シャツ/ブラウス(七分/長袖)', 'parent' => '1', 'gender' => '1', 'big_category' => false],
            ...
            ['name' => 'カーディガン', 'parent' => '1', 'gender' => '0', 'big_category' => false],
            ['name' => 'カーディガン/ボレロ', 'parent' => '1', 'gender' => '1', 'big_category' => false],
            ...
            ['name' => 'カジュアルパンツ', 'parent' => '3', 'gender' => '1', 'big_category' => false],
            ['name' => 'ハーフパンツ', 'parent' => '3', 'gender' => '1', 'big_category' => false],
            ['name' => 'ワークパンツ/カーゴパンツ', 'parent' => '3', 'gender' => '2', 'big_category' => false],
            ['name' => 'スラックス', 'parent' => '3', 'gender' => '0', 'big_category' => false],
            ['name' => 'チノパン', 'parent' => '3', 'gender' => '2', 'big_category' => false],
            ['name' => 'ペインターパンツ', 'parent' => '3', 'gender' => '1', 'big_category' => false],
            ['name' => 'サルエルパンツ', 'parent' => '3', 'gender' => '2', 'big_category' => false],
            ['name' => 'オーバーオール', 'parent' => '3', 'gender' => '0', 'big_category' => false],
            ['name' => 'オーバーオール/サロペット', 'parent' => '3', 'gender' => '1', 'big_category' => false],
            ['name' => 'クロップドパンツ', 'parent' => '3', 'gender' => '1', 'big_category' => false],
            ['name' => 'ガウチョパンツ', 'parent' => '3', 'gender' => '1', 'big_category' => false],
            ['name' => 'その他', 'parent' => '3', 'gender' => '2', 'big_category' => false],

            // スカート
            ['name' => 'ミニスカート', 'parent' => '4', 'gender' => '1', 'big_category' => false],
            ['name' => 'ひざ丈スカート', 'parent' => '4', 'gender' => '1', 'big_category' => false],
            ['name' => 'ロングスカート', 'parent' => '4', 'gender' => '1', 'big_category' => false],
            ['name' => 'キュロット', 'parent' => '4', 'gender' => '1', 'big_category' => false],
            ['name' => 'その他', 'parent' => '4', 'gender' => '1', 'big_category' => false],

            // ワンピース
            ['name' => 'ミニワンピース', 'parent' => '5', 'gender' => '1', 'big_category' => false],
            ['name' => 'ひざ丈ワンピース', 'parent' => '5', 'gender' => '1', 'big_category' => false],
            ['name' => 'ロングワンピース', 'parent' => '5', 'gender' => '1', 'big_category' => false],
            ['name' => 'その他', 'parent' => '5', 'gender' => '1', 'big_category' => false],
            ...
            ['name' => 'デッキシューズ', 'parent' => '6', 'gender' => '0', 'big_category' => false],
            ['name' => 'ドレス/ビジネス', 'parent' => '6', 'gender' => '2', 'big_category' => false],
            ['name' => 'ハイヒール/パンプス', 'parent' => '6', 'gender' => '1', 'big_category' => false],
            ['name' => 'ミュール', 'parent' => '6', 'gender' => '1', 'big_category' => false],
            ['name' => 'フラットシューズ/バレエシューズ', 'parent' => '6', 'gender' => '1', 'big_category' => false],
            ...
            ['name' => 'トラベルバッグ', 'parent' => '7', 'gender' => '0', 'big_category' => false],
            ['name' => 'ポーチ/バニティ', 'parent' => '7', 'gender' => '1', 'big_category' => false],
            ['name' => 'メッセンジャーバッグ', 'parent' => '7', 'gender' => '1', 'big_category' => false],
            ...
            ['name' => 'イヤリング', 'parent' => '9', 'gender' => '1', 'big_category' => false],
            ['name' => 'ブローチ/コサージュ', 'parent' => '9', 'gender' => '1', 'big_category' => false],
            ['name' => 'チャーム', 'parent' => '9', 'gender' => '1', 'big_category' => false],
            ...
            // スーツ
            ['name' => 'スーツジャケット', 'parent' => '11', 'gender' => '0', 'big_category' => false],
            ['name' => 'スーツベスト', 'parent' => '11', 'gender' => '0', 'big_category' => false],
            ['name' => 'スラックス', 'parent' => '11', 'gender' => '0', 'big_category' => false],
            ['name' => 'セットアップ', 'parent' => '11', 'gender' => '0', 'big_category' => false],
            ['name' => 'その他', 'parent' => '11', 'gender' => '0', 'big_category' => false],

            // スーツ/フォーマル/ドレス
            ['name' => 'スカートスーツ上下', 'parent' => '12', 'gender' => '1', 'big_category' => false],
            ['name' => 'パンツスーツ上下', 'parent' => '12', 'gender' => '1', 'big_category' => false],
            ['name' => 'ドレス', 'parent' => '12', 'gender' => '1', 'big_category' => false],
            ['name' => 'シューズ', 'parent' => '12', 'gender' => '1', 'big_category' => false],
            ['name' => 'ウェディング', 'parent' => '12', 'gender' => '1', 'big_category' => false],
            ['name' => 'その他', 'parent' => '12', 'gender' => '1', 'big_category' => false],
